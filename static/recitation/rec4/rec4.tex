...
\textbf{Defn 8:} Let $R$ be an equivalence relation on $A$. Then, the \textit{equivalence class} of $a \in A$, denoted $4$ $\left[a\right]_R$,
...
\begin{enumerate}[a. ]
\item  Let $A=\{0,1,2\}$ and the function $f:{\mathcal P}(A)\rightarrow \{0,1\}^3$.
...
\item If $f: X \rightarrow Y$ is bijective, and $g: Y \rightarrow Z$ is bijective, what can we say about the cardinalities of $X$ and $Z$? Can you say that $g\circ f $ is bijective?
