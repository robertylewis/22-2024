...
\end{enumerate}
    ...
    \item Consider a relation $R$ on a set $S$ that is reflexive and transitive. Justify whether the relation $R \cup R^{-1}$, where $R^{-1}$ is the inverse, is reflexive, symmetric, and/or transitive.
